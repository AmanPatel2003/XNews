...
const Solutions = () => {
  ...
  <>
    <div className="">
      <div className=" md:px-[25px] xl:px-[0px] xl:w-[1140px] m-auto py-[100px] ">
        <div className="mb-[50px]">
          <img
            ...
            alt="svgicon"
          />
          <h2 className="text-4xl font-mono mb-[25px]">
            XCheck helps News Publishers
          </h2>
        </div>
        <div className="flex justify-between ">
          <div className="px-[13px] w-[33%]">
            <article className="">
              <img
                className="m-auto"
          ...
          <div className="px-[13px] w-[33%]">
            <article className="">
              ...
              <div className=" text-center">
                ...
                <div className="font-montserrat  leading-7">
                  <div className="">
                    XCheck badge separates news website that are doing reliable
                    journalism from others. Badge empowers readers to further
                    investigate origin and transparency of news
                  </div>
                </div>
              </div>
            </article>
    ...
    <section className="p-[55px]">
      <div className="">
        <p className="text-center text-4xl font-monoSpace underline underline-offset-2">
