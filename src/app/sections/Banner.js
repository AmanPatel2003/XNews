...
const Banner = () => (
  <>
    <section className="box-border ">
      <div className="">
        <div className="bg-banner_image bg-cover bg-center flex px-[35px] md:px-[25px]  h-screen align-middle items-center w-full mt-[75px]">
          <div className="h-[229px md:px-[25px] xl:px-[0px] xl:w-[1140px] ml-[20px sm:ml-[40px md:m-auto">
